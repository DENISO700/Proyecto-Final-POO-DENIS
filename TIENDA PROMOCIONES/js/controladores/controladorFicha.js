...
function getPDF() {
    ...
    html2canvas($(".canvas_div_pdf")[0], {
        ...
        pdf.save(`${empresas[0].promociones[document.getElementById("productos").value].nombre}.pdf`);
    });
};
...
function ficha() {
    ...
    if (document.getElementById("productos").value != -1) {
        ...
        <div class="row  ">
            ...
            <div class="col-md-9  col-12 contenido  m-auto bg-success" style="background-color: darkgray;">
                        ...
                        <div class="container col-md-8 mt-3" style="background-color: darkgray;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 ml-auto">
                                    <span class="descuento" style="color: white;" style="font-weight: bold;">${descuento} %</span>
                                </div>
                            </div>
                            ...
                            <div class="row" style="background-color: rgba(177, 27, 27, 0.61);">
                                ...
                                <div id="beauty" class="col-md-4">
                                    <h2 style="color: white;" style="font-weight: bold;" class="my-3" >Codigo QR</h2>
                                    <div id="qr" class="ml-3">

                                    </div>

                                    <button type="button" class="btn btn-dark my-3" onclick="getPDF()">Generar PDF</button>
                                </div>

                                <div class="main col-md-4">
                                    <h2 style="color: black;" style="font-weight: bold;">${empresas[0].promociones[document.getElementById("productos").value].nombre}</h2>
                                    <p style="color: black;" style="font-weight: bold;">${empresas[0].promociones[document.getElementById("productos").value].descripcion}
                                    </p>
                                </div>

                                <div class="main2 col-md-4 mt-4" id="foto">
                                        <img src="${empresas[0].promociones[document.getElementById("productos").value].imagenes[0]}" width="125" height="125" />
                            ...
                            <div class="container col-md-8 mt-3" style="background-color: darkgray;">
                                ...
                                <div class="row" style="background-color: rgba(177, 27, 27, 0.61);">
                                    ...
                                    <div id="beauty" class="col-md-4">
                                        ...
                                        <button type="button" class="btn btn-danger my-3" onclick="getPDF()">Generar PDF</button>
                                    </div>
                                    ...
                                    <div class="main2 col-md-4 mt-4" id="foto">
                                            <img src="/images/log-placeholder.png" width="125" height="125" />
